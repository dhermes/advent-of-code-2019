...
def main():
    ...
    # droid.send_command("AND E J\n")
    # droid.send_command("OR B T\n")
    # droid.send_command("OR C T\n")
    # droid.send_command("NOT T T\n")
    # droid.send_command("AND A T\n")
    # droid.send_command("AND D T\n")
    # droid.send_command("OR T J\n")
    # droid.send_command("NOT A T\n")
    # droid.send_command("OR T J\n")
    # # Attempt 3
    ...
    # Attempt 4
    droid.send_command("NOT B J\n")
    droid.send_command("NOT H T\n")
    droid.send_command("AND F T\n")
    droid.send_command("OR C T\n")
    droid.send_command("NOT T T\n")
    droid.send_command("OR T J\n")
    droid.send_command("AND A J\n")
